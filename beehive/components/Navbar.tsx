...
export default function Navbar() {
  ...
  const navItemStyle = "bg-transparent text-[#4B2E05] text-lg font-medium px-4 py-2 flex items-center justify-center hover:bg-transparent focus:bg-transparent data-[state=open]:bg-transparent data-[active]:bg-transparent border-none shadow-none ring-0 outline-none transition-none cursor-pointer";
              ...
              <NavigationMenuItem className="group/nav">
                <NavigationMenuTrigger className={navItemStyle}>
                  <span className="relative">
                    Beranda
                    <span className="absolute left-0 -bottom-1 w-0 h-[2.5px] bg-[#4B2E05] transition-all duration-300 group-hover/nav:w-full" />
                  </span>
                </NavigationMenuTrigger>
              ...
              <NavigationMenuItem className="group/nav">
                <NavigationMenuLink asChild>
                  <Link href="/klasifikasi" className={navItemStyle}>
                    <span className="relative">
                      Klasifikasi Lebah
                      <span className={cn("absolute left-0 -bottom-1 h-[2.5px] bg-[#4B2E05] transition-all duration-300 group-hover/nav:w-full", pathname === "/klasifikasi" ? "w-full" : "w-0")} />
                    </span>
                  </Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem className="group/nav">
                <NavigationMenuLink asChild>
                  <Link href="/informasi" className={navItemStyle}>
                    <span className="relative">
                      Informasi Lebah
                      <span className={cn("absolute left-0 -bottom-1 h-[2.5px] bg-[#4B2E05] transition-all duration-300 group-hover/nav:w-full", pathname === "/informasi" ? "w-full" : "w-0")} />
                    </span>
                  </Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
